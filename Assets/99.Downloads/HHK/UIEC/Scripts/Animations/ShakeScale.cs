...
namespace HHK.UIEC
{
    ...
    public class ShakeScale : UIECAnimation
    {
        ...
        {
            return DOTween.Sequence().Append(target.transform.DOShakeScale(duration, strength, vibrato, randomness, fadeOut).SetEase(ease));
        }
    }
