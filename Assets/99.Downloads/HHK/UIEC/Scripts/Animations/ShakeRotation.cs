...
namespace HHK.UIEC
{
    ...
    public class ShakeRotation : UIECAnimation
    {
        ...
        {
            return DOTween.Sequence().Append(target.transform.DOShakeRotation(duration, strength, vibrato, randomness, fadeOut).SetEase(ease));
        }
    }
}