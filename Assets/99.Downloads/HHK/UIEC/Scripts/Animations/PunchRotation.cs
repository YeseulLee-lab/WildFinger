...
namespace HHK.UIEC
{
    ...
    public class PunchRotation : UIECAnimation
    {
        ...
        {
            return DOTween.Sequence().Append(target.transform.DOPunchRotation(rotation, duration, vibrato, elasticity).SetEase(ease));
        }
    }
